...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item">
                <a href="<?= base_url('pegawai/kehadiran') ?>" class="nav-link  <?php if($c_judul == "Kehadiran") {echo 'active';} ?>">
                    <i class="nav-icon far fa-calendar-check"></i>
                    <p>Kehadiran</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('pegawai/tunjangan') ?>" class="nav-link  <?php if($c_judul == "Tunjangan") {echo 'active';} ?>">
